...
export default function ArticlesPage_02(): React.ReactNode {
    return <Layout title="Being Colourblind">
        ...
        <div className="articles_page">
            ...
            <div className="articles_page_text">
                ...
                <p>
                    <em>12.02.2026</em><br />
                    <br />
                    Hey! Mind you — I am not <em>colourblind</em>!
                    I am <em>slightly red-green colour deficient</em>.
                ...
                <div className="articles_page_text_with_image left">
                    <div className="articles_page_text_with_image_block">
                        <a href="/picture/d81dac58-b115-426e-9109-5d8ed37c1f09">
                            <img src="/20220509_182943.jpg" />
                        </a>
                        <figcaption>
                            Grogu (green)
                        </figcaption>
                    ...
                    <p>
                        ...
                        “Actually, <em>that</em> one is grey.”<br />
                ...
                <div className="articles_page_text">
                    <p>
                        ...
                        Even when they were just three years old, they could see things I've
                        never seen.
                ...
                <div className="articles_page_text_with_image right">
                    <div className="articles_page_text_with_image_block">
                        <a href="/picture/e8f9aa52-f132-443e-9d12-073ac3031689">
                            <img src="/20201121_191014_2.JPG" />
                        </a>
                        <figcaption>
                            Lüneburg, 2020
                        </figcaption>
                    ...
                    <p>
                        ...
                        they do to you. But you have to be careful you don't place ochre and may green
                        too close together on the canvas — to you, they can
                        look almost the same. And sometimes you need to ask the people around
                        you for help.<br />
                        <br />
                        It means you will never truly understand what you are missing out on,
                        ...
                        what you expect. And sometimes they smile when there is no reason for smiling.<br />
                        <br />
                        And sometimes, you simply stop caring.
                        You don’t bother. You just use whatever colour feels right and paint
                        like <a href="/tag/genre/wrong_colour/">this</a>.
                        <br />
                    </p>
                </div>
