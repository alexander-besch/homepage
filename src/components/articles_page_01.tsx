...
export default function ArticlesPage_01(): React.ReactNode {
    return <Layout title="Painting Drawing">

        <div className="articles_page">


            <div className="articles_page_text">
                <h1>Painting and/or Drawing</h1>
                ...
                <p>
                    ...
                    <br />
                    “Don’t
                    use <span className="articles_page_italic">painting</span> and <span className="articles_page_italic">drawing</span>!
                    Just one word!” my son Christopher told me.<br />
                    He helped me create this homepage and spent hours patiently explaining to his old dad how to use TypeScript,
                    React, and all that kind of stuff.<br />
                    ...
                    If you paint it, the edge of the house is simply where the ochre ends and the light blue begins. Easy.<br />
                    <br />
